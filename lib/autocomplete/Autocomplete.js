...
var factory = function factory(Chip, Input) {
  var Autocomplete = function (_Component) {
    ...
    function Autocomplete() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        _this.setState({ active: '', focus: true, direction: _this.calculateDirection(_this.props.direction) });
    ...
    _createClass(Autocomplete, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (this.state.focus && this.props.direction !== nextProps.direction) {
          var direction = this.calculateDirection(nextProps.direction);
          this.setState({ direction: direction });
        }
      }
    }, {
      key: 'calculateDirection',
      value: function calculateDirection(propsDirection) {
  ...
  Autocomplete.propTypes = {
    ...
    suggestionMatch: _propTypes2.default.oneOf(['start', 'anywhere', 'word']),
